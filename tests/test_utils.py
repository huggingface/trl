...
class TestBatchGeneration(unittest.TestCase):
    ...
    def test_mini_batch_generation(self):
        ...
        max_length = query_responses.shape[1]

        self.assertGreater(max_length, context_length)
        self.assertEqual(query_responses.shape, (bs, max_length))
        self.assertEqual(logits.shape, (bs, max_length, self.model.config.vocab_size))
