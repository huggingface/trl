...
from transformers.utils import is_peft_available, is_torch_xla_available, is_vision_available
...
class TestOnlineDPOTrainer(TrlTestCase):
    ...
    def test_nonfinite_loss_is_visible_in_log_history(self):
        ...
        class NonFiniteLossOnlineDPOTrainer(OnlineDPOTrainer):
        ...
        trainer = NonFiniteLossOnlineDPOTrainer(
            model=self.model,
            reward_funcs=self.reward_model,
            args=training_args,
            train_dataset=dataset,
