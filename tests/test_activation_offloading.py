...
from transformers.testing_utils import require_torch_accelerator, require_peft
from transformers.utils import is_peft_available
from datasets import load_dataset

from trl.models.activation_offloading import OffloadActivations, NoOpManager
