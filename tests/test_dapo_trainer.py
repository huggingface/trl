...
class DAPOTrainerTester(unittest.TestCase):
    def test_init_minimal(self):
        # Test that DAPOTrainer can be instantiated with only model, reward_model and train_dataset
    ...
    def test_training_multiple_reward_funcs(self):
        # Test that DAPOTrainer can be instantiated with multiple reward functions
        dataset = load_dataset("trl-internal-testing/zen", "standard_prompt_only", split="train")
    ...
    def test_training_multiple_reward_funcs_with_weights(self):
        """Test that DAPOTrainer can handle multiple reward functions with weights."""
        dataset = load_dataset("trl-internal-testing/zen", "standard_prompt_only", split="train")
