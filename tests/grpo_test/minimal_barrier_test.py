...
def main():
    ...
    print(f"[DEBUG] Process rank {accelerator.process_index} set to device {local_device}")
    ...
    print(f"[DEBUG] Process rank {accelerator.process_index} passed torch.distributed.barrier()")

    # Now call accelerator.wait_for_everyone()
    print(f"[DEBUG] Process rank {accelerator.process_index} calling accelerator.wait_for_everyone()")
    accelerator.wait_for_everyone()
    print(f"[DEBUG] Process rank {accelerator.process_index} passed accelerator.wait_for_everyone()")
