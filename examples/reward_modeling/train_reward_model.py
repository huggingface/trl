...
########################################################################
# This is a fully working simple example to use RewardTrainer from trl on any HF model.
#
# This example fine-tunes OPT model on the hh-rlhf dataset
# We eventually use adapters from PEFT library to train Low Rank Adapters.
