...
"""
DPPO (Decoupled Proximal Policy Optimization) Training Script

DPPO is a variant of PPO that decouples the optimization of the policy and value function
for improved training stability. This is based on the Stable-RL paper:
...
python examples/scripts/ppo/dppo.py \
    ...
    --output_dir pythia-1b-deduped-descriptiveness-sentiment-trl-style-dppo \
...
if __name__ == "__main__":
    parser = HfArgumentParser((ScriptArguments, DPPOConfig, ModelConfig))
