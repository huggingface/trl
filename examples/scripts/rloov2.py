...
from trl.trainer.rloov2_config import RLOOv2Config
from trl.trainer.rloov2_trainer import RLOOv2Trainer
...
if __name__ == "__main__":
    parser = TrlParser((ScriptArguments, RLOOv2Config, ModelConfig))
