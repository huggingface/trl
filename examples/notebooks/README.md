...
| --- | --- | --- |
| [`openenv_wordle_grpo_qlora.ipynb`](https://github.com/huggingface/trl/tree/main/examples/notebooks/openenv_wordle_grpo_qlora.ipynb) | GRPO using QLoRA to play Worldle on an OpenEnv environment | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/huggingface/trl/blob/main/examples/notebooks/openenv_wordle_grpo_qlora.ipynb) |
