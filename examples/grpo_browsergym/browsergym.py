...
python examples/grpo_browsergym/browsergym.py

# With vLLM colocate (1 GPU, requires vLLM support for the model)
python examples/grpo_browsergym/browsergym.py --use-vllm

# With vLLM server (2 GPUs)
CUDA_VISIBLE_DEVICES=0 trl vllm-serve --model Qwen/Qwen3.5-2B --host 0.0.0.0 --port 8000
CUDA_VISIBLE_DEVICES=1 python examples/grpo_browsergym/browsergym.py --use-vllm --vllm-mode server
```
"""
