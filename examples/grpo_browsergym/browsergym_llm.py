...
```sh
python examples/grpo_browsergym/browsergym_llm.py --vllm-mode colocate
```
...
```sh
CUDA_VISIBLE_DEVICES=1 python examples/grpo_browsergym/browsergym_llm.py --vllm-mode server --vllm-server-url http://localhost:8001
```
"""
