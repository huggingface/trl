...
# - Sourced from Qwen/Qwen3.5-0.8B because its bundled tokenizer defaults to thinking disabled.
#   Switching to a >=4B Qwen3.5 release will flip that default.
...
push_to_hub(model, processor, None, "tiny", "NoThink")
