...
# Like the Ultra checkpoint, the Lightning checkpoint keeps the Mamba mixer weights in bfloat16, so no fp32 restore
# here.
...
push_to_hub(model, tokenizer, generation_config, "tiny", "3.5-lightning")
