...
GROUP_NAME=minillm/openr1-math-220k/qwen2.5-1.5B/lr5e-6_vllm_l4096_bs256_init_sft2695
JOB_TYPE=train
...
trl/scripts/minillm.py \
    --model_name_or_path results/train/sft/openr1-math-220k/qwen2.5-1.5B/lr2e-4_wm200_cos_e10/checkpoint-2695/ \
    --dtype bfloat16 \
