...
| [`examples/scripts/rloo.py`](https://github.com/huggingface/trl/blob/main/examples/scripts/rloo.py) | This script shows how to use the [`experimental.rloo.RLOOTrainer`] to fine-tune a model to improve its ability to solve math questions. |
