...
| [`examples/scripts/nemo_gym/train_multi_env.py`](https://github.com/huggingface/trl/blob/main/examples/scripts/nemo_gym/train_multi_env.py) | This script shows how to use the [`GRPOTrainer`] to train language models in NVIDIA NeMo-Gym environments. Supports multi-turn and tool calling environments, and multi-environment training. See the [NeMo-Gym Integration](nemo_gym_integration) guide for setup and usage. |
