...
| [`opsd_math`](https://github.com/huggingface/trl/tree/main/examples/opsd_math) | On-policy self-distillation with [`experimental.opsd.OPSDTrainer`] on math/reasoning problems using ground-truth solutions as privileged teacher context. | |
