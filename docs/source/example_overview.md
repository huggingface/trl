...
Example scripts for experimental trainers (under `trl.experimental`) live alongside the trainer in `trl/experimental/<name>/` and are linked from each trainer's documentation page when available.
