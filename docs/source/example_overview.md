...
| [`async_grpo_timesx`](https://github.com/huggingface/trl/tree/main/examples/async_grpo_timesx) | AsyncGRPO training of a numeric time-series forecaster on the [TimesX](https://arxiv.org/abs/2607.06973) evaluation benchmark, with a MASE-based reward. | |
