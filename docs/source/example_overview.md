...
| [`examples/scripts/alphapo.py`](https://github.com/huggingface/trl/blob/main/examples/scripts/alphapo.py) | This script shows how to use the [`AlphaPOTrainer`] to fine-tune a model to increase helpfulness and harmlessness using the [Anthropic/hh-rlhf](https://huggingface.co/datasets/Anthropic/hh-rlhf) dataset. |
