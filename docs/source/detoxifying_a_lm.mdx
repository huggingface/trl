...
<div class="column" style="text-align:center">
  <div class="column">
    <img src="https://huggingface.co/datasets/trl-internal-testing/example-images/resolve/main/images/trl-toxicity-final-plot.png" style="width:50%">
  </div>
  <div class="column">
    <img src="https://huggingface.co/datasets/trl-internal-testing/example-images/resolve/main/images/trl-toxicity-without-std.png" style="width:50%">
  </div>
</div>
