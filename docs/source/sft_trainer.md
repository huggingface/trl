...
To train on completions only, simply use a [prompt-completion](dataset_formats.md#prompt-completion) dataset. In this mode, loss is computed solely on the completion part.
