...
The [SLiC](https://arxiv.org/abs/2309.06657v1) authors propose to use a hinge loss on the normalized likelihood and the `DPOTrainer` can be switched to this loss via the `loss_type="hinge"` argument.
