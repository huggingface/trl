...
The [SLiC](https://arxiv.org/abs/2305.10425) authors propose to use a hinge loss on the normalized likelihood in the [DSO](https://arxiv.org/abs/2309.06657) paper. The `DPOTrainer` can be switched to this loss via the `loss_type="hinge"` argument.
