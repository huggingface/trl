...
The [SPPO](https://arxiv.org/abs/2405.00675) authors claim that SPPO is capable of solving the Nash equilibrium iteratively by pushing a to be as large as 1/2 and b to be as small as -1/2 and can alleviate data sparsity issues.
