...
| Prompt-completion               | [Go to section](#from-prompt-completion-to-language-modeling-dataset)               | N/A                                                                                 | [Go to section](#from-prompt-completion-to-prompt-only-dataset)               | N/A                                                                          | N/A                                                        | N/A                                                                                   |
| Prompt-only                     | N/A                                                                                 | N/A                                                                                 | N/A                                                                           | N/A                                                                          | N/A                                                        | N/A                                                                                   |
| Preference with implicit prompt | [Go to section](#from-preference-with-implicit-prompt-to-language-modeling-dataset) | [Go to section](#from-preference-with-implicit-prompt-to-prompt-completion-dataset) | [Go to section](#from-preference-with-implicit-prompt-to-prompt-only-dataset) | N/A                                                                          | [Go to section](#from-implicit-to-explicit-prompt-dataset) | [Go to section](#from-preference-with-implicit-prompt-to-unpaired-preference-dataset) |
| Preference                      | [Go to section](#from-preference-to-language-modeling-dataset)                      | [Go to section](#from-preference-to-prompt-completion-dataset)                      | [Go to section](#from-preference-to-prompt-only-dataset)                      | [Go to section](#from-preference-to-preference-with-implicit-prompt-dataset) | N/A                                                        | [Go to section](#from-preference-to-unpaired-preference-dataset)                      |
| Unpaired preference             | [Go to section](#from-unpaired-preference-to-language-modeling-dataset)             | [Go to section](#from-unpaired-preference-to-prompt-completion-dataset)             | [Go to section](#from-unpaired-preference-to-prompt-only-dataset)             | N/A                                                                          | N/A                                                        | N/A                                                                                   |



#### From prompt-completion to language modeling dataset

To convert a prompt-completion dataset into a language modeling dataset, you can just concatenate the prompt and the completion.
...
just concat the prompt and the completion

#### From prompt-completion to prompt-only dataset

just remove the completion

#### From preference with implicit prompt to language modeling dataset

remove the rejected, rename the chosen to text

#### From preference with implicit prompt to prompt-completion dataset

extract the prompt, remove the rejected, rename the chosen to completion

#### From preference with implicit prompt to prompt-only dataset

extract the prompt, remove the rejected and the chosen
