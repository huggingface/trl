...
| From \ To                       | Preference with implicit prompt | Preference       | Unpaired preference                               |
| ------------------------------- | ------------------------------- | ---------------- | ------------------------------------------------- |
| Preference with implicit prompt | N/A                             | `extract_prompt` | `extract_prompt` then `unpair_preference_dataset` |
| Preference                      | `dispatch_prompt`               | N/A              | `unpair_preference_dataset`                       |
...
| Prompt-completion               | [🔗⬇️](#from-prompt-completion-to-language-modeling-dataset)               | N/A                                                                                 | [🔗⬇️](#from-prompt-completion-to-prompt-only-dataset)               | N/A                                                                          | N/A                                                        | N/A                                                                                   |
| Prompt-only                     | N/A                                                                                 | N/A                                                                                 | N/A                                                                           | N/A                                                                          | N/A                                                        | N/A                                                                                   |
| Preference with implicit prompt | [🔗⬇️](#from-preference-with-implicit-prompt-to-language-modeling-dataset) | [🔗⬇️](#from-preference-with-implicit-prompt-to-prompt-completion-dataset) | [🔗⬇️](#from-preference-with-implicit-prompt-to-prompt-only-dataset) | N/A                                                                          | [🔗⬇️](#from-implicit-to-explicit-prompt-dataset) | [🔗⬇️](#from-preference-with-implicit-prompt-to-unpaired-preference-dataset) |
| Preference                      | [🔗⬇️](#from-preference-to-language-modeling-dataset)                      | [🔗⬇️](#from-preference-to-prompt-completion-dataset)                      | [🔗⬇️](#from-preference-to-prompt-only-dataset)                      | [🔗⬇️](#from-preference-to-preference-with-implicit-prompt-dataset) | N/A                                                        | [🔗⬇️](#from-preference-to-unpaired-preference-dataset)                      |
| Unpaired preference             | [🔗⬇️](#from-unpaired-preference-to-language-modeling-dataset)             | [🔗⬇️](#from-unpaired-preference-to-prompt-completion-dataset)             | [🔗⬇️](#from-unpaired-preference-to-prompt-only-dataset)             | N/A                                                                          | N/A                                                        | N/A                                                                                   |



#### From prompt-completion to language modeling dataset

To convert a prompt-completion dataset into a language modeling dataset, you can concatenate the prompt and the completion.
...
To convert a prompt-completion dataset into a prompt-only dataset, you can remove the completion.
...
To convert a preference with implicit prompt dataset into a language modeling dataset, you can remove the rejected rename the `chosen` to `text`.
...
To convert a preference dataset with implicit prompt into a prompt-completion dataset, you can extract the prompt with [`extract_prompt`], remove the rejected, and rename the column `"chosen"` to `"completion"`.
...
To convert a preference dataset with implicit prompt into a prompt-only dataset, you can extract the prompt with [`extract_prompt`], and remove the rejected and the chosen.
...
#### From implicit to explicit prompt dataset

To convert a preference dataset with implicit prompt into a preference dataset with explicit prompt, you can extract the prompt with [`extract_prompt`].
...
extract the prompt, and unpair the dataset

#### From preference to language modeling dataset

remove the rejected, concat the prompt and the chosen to create the text

#### From preference to prompt-completion dataset

remove the rejected, rename the chosen to completion

#### From preference to prompt-only dataset

remove chosen and rejected

#### From preference to preference with implicit prompt dataset

concat the prompt to chosne and rejected
...
remove the label, concat the prompt and the completion to create the text
...
remove the label and the completion

#### From unpaired preference to preference with implicit prompt dataset

concat the prompt to the completion
