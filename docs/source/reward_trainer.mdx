...
As in the LLAMA-2 paper, you can add a margin to the loss by adding a `margin` entry to the dataset. The reward collator will automatically pass it through and the loss will be computed accordingly.
