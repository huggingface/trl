...
> [!WARNING]
> TRL currently only supports vLLM versions from `0.10.2` to `0.15.0`. Please ensure you have a version in this range installed to avoid compatibility issues.
