...
> [!WARNING]
> TRL currently only supports vLLM versions from `0.19.0` to `0.28.0`. Please ensure you have a version in this range installed to avoid compatibility issues.
