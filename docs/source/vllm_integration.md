...
> [!WARNING]
> TRL currently only supports vLLM versions from `0.16.0` to `0.25.1`. Please ensure you have a version in this range installed to avoid compatibility issues.
