...
For a complete working example, see the [SFT with LoRA/QLoRA notebook](https://github.com/huggingface/trl/blob/main/examples/sft_qlora/sft_trl_lora_qlora.ipynb).
...
- **[SFT with LoRA/QLoRA Notebook](https://github.com/huggingface/trl/blob/main/examples/sft_qlora/sft_trl_lora_qlora.ipynb)** - Complete working example showing both LoRA and QLoRA implementations
