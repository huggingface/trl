...
TRL supports the KTO Trainer for training language models from unpaired preference data, as described in the [report](https://github.com/ContextualAI/HALOs/blob/main/assets/report.pdf) by  Kawin Ethayarajh, Winnie Xu, Dan Jurafsky, and Douwe Kiela.
