...
def is_vllm_available() -> bool:
    ...
    if _vllm_available:
        if not (version.parse("0.10.3") <= version.parse(_vllm_version) <= version.parse("0.11.2")):
            warnings.warn(
                "TRL currently supports vLLM versions: 0.10.3, 0.11.0, 0.11.1, 0.11.2. You have version "
