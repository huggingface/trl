...
class VLLMClient:
    ...
    def __init__(
        ...
        # Match the default concurrency so connections can be reused across batches.
        adapter = HTTPAdapter(max_retries=retry_strategy, pool_maxsize=DEFAULT_MAX_CONCURRENT_REQUESTS)
    ...
    def image_features(
        self, images: list[list | None], max_concurrent_requests: int = DEFAULT_MAX_CONCURRENT_REQUESTS
    ) -> list[dict | None]:
        """
