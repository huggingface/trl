...
_import_structure = {
    ...
    "utils": ["SUPPORTED_ARCHITECTURES", "setup_chat_format", "unwrap_model_for_generation", "prepare_fsdp"],
}
...
if TYPE_CHECKING:
    ...
    from .utils import SUPPORTED_ARCHITECTURES, prepare_fsdp, setup_chat_format, unwrap_model_for_generation
