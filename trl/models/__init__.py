...
_import_structure = {
    ...
    "utils": ["SUPPORTED_ARCHITECTURES", "prepare_deepspeed", "prepare_fsdp", "setup_chat_format", "unwrap_model_for_generation"],
}
...
if TYPE_CHECKING:
    ...
    from .utils import SUPPORTED_ARCHITECTURES, prepare_deepspeed, prepare_fsdp, setup_chat_format, unwrap_model_for_generation
