...
def ddim_with_logprob(
    ...
    variance = _get_variance(timestep, prev_timestep)
...
class DefaultDDPOPipeline(DDPOStableDiffusionPipeline):
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                scheduler_output = self.scheduler_step(self.scheduler, noise_pred, t, latents, **extra_step_kwargs)
    ...
    def scheduler_step(self, *args, **kwargs) -> DDPOSchedulerOutput:
        return ddim_with_logprob(self.scheduler, *args, **kwargs)
