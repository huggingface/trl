...
@dataclass
class DDPOPipelineSDXLOutput(object):
    """
...
@dataclass
class DDPOSchedulerSDXLOutput(object):
    """
...
class DDPOStableDiffusionXLPipeline(object):
    """
    ...
    def scheduler_step(self, *args, **kwargs) -> DDPOSchedulerSDXLOutput:
        raise NotImplementedError
...
def scheduler_step(
    ...
    return DDPOSchedulerSDXLOutput(prev_sample.type(sample.dtype), log_prob)
...
def pipeline_step(
    ...
    **kwargs,
    ...
    return DDPOPipelineSDXLOutput(images=image, latents=all_latents, log_probs=all_log_probs, add_time_ids=add_time_ids)
...
class DefaultDDPOStableDiffusionXLPipeline(DDPOStableDiffusionXLPipeline):
    ...
    def __call__(self, *args, **kwargs) -> DDPOPipelineSDXLOutput:
