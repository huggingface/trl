...
"""
Run the ORPO training script with the commands below. In general, the optimal configuration for ORPO will be similar to
that of DPO without the need for a reference model.

# Full training:
```bash
python trl/scripts/orpo.py \
