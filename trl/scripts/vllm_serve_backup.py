...
class WeightSyncWorkerExtension:
    ...
    def init_communicator(self, host: str, port: int, world_size: int) -> None:
        ...
        print('we have pynccl_comm: ', self.pynccl_comm)

        # The client process that sends updated weights has the highest rank
        self.client_rank = world_size - 1

        print('we have client_rank: ', self.client_rank)
...
def llm_worker(script_args: ScriptArguments, data_parallel_rank: int, master_port: int, connection: Connection) -> None:
    ...
    dna_requested = script_args.use_dna_llm and DNA_LLM_AVAILABLE and script_args.dna_model_name
...
def main(script_args: ScriptArguments):
    ...
    async def generate(request: GenerateRequest):
        ...
        if request.dna_sequences and script_args.use_dna_llm and DNA_LLM_AVAILABLE and script_args.dna_model_name:
