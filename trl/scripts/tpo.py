...
from trl.scripts.grpo import GRPOScriptArguments as TPOScriptArguments
...
def main(script_args, training_args, model_args, dataset_args):
    ...
    from trl import TPOTrainer, get_dataset, get_kbit_device_map, get_peft_config, get_quantization_config
...
def make_parser(subparsers: argparse._SubParsersAction | None = None, prog: str | None = None):
    from trl import DatasetMixtureConfig, ModelConfig, TPOConfig, TrlParser

    dataclass_types = (TPOScriptArguments, TPOConfig, ModelConfig, DatasetMixtureConfig)
    if subparsers is not None:
        parser = subparsers.add_parser("tpo", help="Run the TPO training script", dataclass_types=dataclass_types)
    else:
