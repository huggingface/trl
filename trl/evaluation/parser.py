...
from trl.evaluation.utils import *
from trl.evaluation.trajectory import extract_program, extract_program_output
...
def parse_ground_truth(example: Dict[str, Any], data_name):
    if "gt_cot" in example and "gt" in example:
        if data_name in ["math", "eleuther_math", "math500"]:
    ...
    # parse ground truth
    if data_name in ["math", "minerva_math", "eleuther_math", "math500"]:
