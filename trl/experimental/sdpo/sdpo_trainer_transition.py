...
from ..self_distillation.unified_base_self_distillation_trainer import UnifiedBaseSelfDistillationTrainer
...
class SDPOTrainer(UnifiedBaseSelfDistillationTrainer):
    """
