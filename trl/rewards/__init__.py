...
_import_structure = {
    ...
    "format_rewards": ["graduated_format_reward", "think_format_reward"],
    "other_rewards": ["get_repetition_penalty_reward", "get_soft_overlong_punishment"],
}


if TYPE_CHECKING:
    from .accuracy_rewards import (
        accuracy_reward,
        get_cosine_scaled_reward,
        get_length_scaled_accuracy_reward,
        reasoning_accuracy_reward,
    )
    from .format_rewards import graduated_format_reward, think_format_reward
