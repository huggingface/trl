...
class SFTConfig(TrainingArguments):
    ...
    Parameters:
        ...
        model_init_kwargs (`dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`SFTTrainer`] is provided as a string. If you're training a Causal (Visual or Text) Language model
            with an MoE architecture and want to include the load balancing/auxilliary loss as a part of the final loss,
            remember to set `output_router_logits=True` in this dictionary.
