...
class DPOConfig(TrainingArguments):
    ...
    Args:
        ...
        rpo_alpha ('float', defaults to `None`):
            The alpha parameter from the [RPO](https://huggingface.co/papers/2404.19733) paper V3. If None, no weighting is applied and the loss is the same as the DPO loss.
    """
