...
class DPOConfig(TrainingArguments):
    ...
    Args:
        ...
        loss_type (`str`, defaults to `"sigmoid"`):
            ...
            `"kto_pair"` from the HALOs [report](https://github.com/ContextualAI/HALOs/blob/main/assets/report.pdf), `"bco_pair"` from [BCO](https://arxiv.org/abs/2404.04656) paper or `"robust"` from [RobustDPO](https://arxiv.org/abs/2403.00409) paper.
