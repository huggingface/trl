...
class RLOOTrainer_NEW(Trainer):
    ...
    def _compute_loss(self, model, inputs):
        ...
        # We need to compute per_token_logps again here (even though we computed current_per_token_logps 
        # in _generate_and_score_completions) because:
        # 1. The logprobs in _generate_and_score_completions are computed with torch.no_grad() (no gradients)
        # 2. We need logprobs with gradients here for backpropagation through the loss
