...
class RLOOConfig_NEW(TrainingArguments):
    ...
    Parameters:
        ...
        include_kl_in_reward (`bool`, *optional*, defaults to `True`):
            Whether to include the KL penalty in the reward. If `False`, the KL penalty is only used for clipping.
    ...
    include_kl_in_reward: bool = field(
        default=True,
        metadata={"help": "Whether to include the KL penalty in the reward. If `False`, the KL penalty is only used for clipping."},
    )
