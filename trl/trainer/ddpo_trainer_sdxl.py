...
from ..models import DDPOStableDiffusionXLPipeline
from . import BaseTrainer, DDPOConfigSDXL
...
class DDPOTrainerSDXL(BaseTrainer):
    """
    ...
    def __init__(
        self,
        config: DDPOConfigSDXL,
        reward_function: Callable[[torch.Tensor, Tuple[str], Tuple[Any]], torch.Tensor],
        prompt_function: Callable[[], Tuple[str, Any]],
        sd_pipeline: DDPOStableDiffusionXLPipeline,
