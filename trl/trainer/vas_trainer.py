...
class VASTrainer(BaseTrainer):
    """
    The VASTrainer train a Value model to be used in Value Augmented Sampling inference (https://arxiv.org/abs/2405.06639).
    ...
    def loss(
        ...
        vf_losses = (vpreds - returns) ** 2
        vf_loss = 0.5 * masked_mean(vf_losses, mask)
