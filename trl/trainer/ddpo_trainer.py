...
from .utils import DDPOPipeline, DDPOScheduler
...
class DDPOTrainer(BaseTrainer):
    def __init__(
        ...
        if config.use_lora:
            ...
            trainable_layers = AttnProcsLayers(self.pipeline.unet.attn_processors)
        else:
            trainable_layers = self.pipeline.unet
