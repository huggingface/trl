...
_import_structure = {
    ...
    "judges": ["HuggingFaceJudge", "MockAPIJudge", "MockJudge", "OpenAIJudge", "PairRMJudge"],
}
...
if TYPE_CHECKING:
    ...
    from .judges import HuggingFaceJudge, MockAPIJudge, MockJudge, OpenAIJudge, PairRMJudge
