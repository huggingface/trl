...
class RewardTrainer(Trainer):
    ...
    def __init__(
        ...
        if args.model_init_kwargs is None:
            ...
            raise ValueError("You passed model_kwargs to the RewardTrainer. But your model is already instantiated.")
        else:
            ...
            if torch_dtype is not None:
                ...
                if torch_dtype != "auto" and not isinstance(torch_dtype, torch.dtype):
                    raise ValueError(
                        f"Invalid `torch_dtype` passed to the RewardConfig. Expected a string with either `torch.dtype` or 'auto', but got {torch_dtype}."
                    )
