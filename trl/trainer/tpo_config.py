...
class TPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        tpo_l_gamma (`float`, defaults to `0.5`):
            A target reward margin for the TPO-L loss, used only when the "tpo-l" option is enabled.
    ...
    loss_type: Literal["sigmoid", "hinge", "ipo", "tpo-l"] = "sigmoid"
    disable_dropout: bool = True
    tpo_alpha: float = 0.05
    ...
    is_three_preference: Optional[bool] = True
