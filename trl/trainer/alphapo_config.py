...
@dataclass
class AlphaPOConfig(TrainingArguments):
    r"""
    Configuration class for the [`AlphaPOTrainer`].

    This class includes only the parameters that are specific to AlphaPO training. For a full list of training arguments,
...
- alpha -> 0: SimPO's log reward."""
    ...
    gamma_beta_ratio: float = field(
        default=0.25,
        metadata={"help": "Parameter controlling the target reward margin."},
    )
