...
from ..experimental.rloo import RLOOTrainer as ExperimentalRLOOTrainer


class RLOOTrainer(ExperimentalRLOOTrainer):
    """
    Initialize RLOOTrainer.

    .. warning::
        This class is deprecated and will be removed in TRL 0.29.0. Please use
        `trl.experimental.rloo.RLOOTrainer` instead. See https://github.com/huggingface/trl/issues/4223
        for more information.

    For full documentation, see [`trl.experimental.rloo.RLOOTrainer`].
    """

    def __init__(self, *args, **kwargs):
        warnings.warn(
            "RLOOTrainer is deprecated and will be removed in TRL 0.29.0. "
            "Please use `trl.experimental.rloo.RLOOTrainer` instead. "
