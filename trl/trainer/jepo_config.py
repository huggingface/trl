...
class JEPOConfig(_BaseConfig):
    ...
    Parameters:
        ...
        model_init_kwargs (`str`, `dict[str, Any]`, *optional*):
            ...
            argument of the [`JEPOTrainer`] is provided as a string.
        ...
        loss_type (`str`, *optional*, defaults to `"norm_jepo"`):
            Specifies the loss formulation to use. Supported values are:

            - `"norm_jepo"`: Aggregates token-level losses by normalizing over sequence length. 
            - `"unnorm_jepo"`: Aggregates token-level losses without normalization. 
    ...
    supervised_loss_weight: float = field(
        default=0.1,
        metadata={
            "help": "Weight for the supervised loss. If greater than `0.0`, the loss optimized will be a weighted sum "
            "between the JEPO loss and a supervised loss (cross-entropy between the model predictions and the "
    ...
    loss_type: str = field(
        default="norm_jepo",
        metadata={
            "help": "Specifies the loss formulation to use. Supported values are 'norm_jepo' and 'unnorm_jepo'. "
            "'norm_jepo': Aggregates token-level losses by normalizing over sequence length. "
            "'unnorm_jepo': Aggregates token-level losses without normalization. "
        },
    )
