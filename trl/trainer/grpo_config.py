...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        vllm_importance_sampling_correction (`bool`, *optional*, defaults to `False`):
            Whether to apply truncated importance sampling between vLLM completion logprobs and recomputed logprobs. [Your Efficient RL Framework Secretly Brings You Off-Policy RL Training](https://fengyao.notion.site/off-policy-rl)
    ...
    def __post_init__(self):
        ...
        if not self.use_vllm and self.vllm_importance_sampling_correction:
            raise ValueError("'vllm_importance_sampling_correction' requires vLLM generation. Enable with 'use_vllm'.")
