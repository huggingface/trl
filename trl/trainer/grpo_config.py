...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        use_self_certainty (`bool`, *optional*, defaults to `False`):
            Whether to use self-certainty for the rewards. If `True`, the self-certainty is computed for each token. TODO:
    ...
    use_self_certainty: bool = field(
        default=False,
        metadata={
            "help": "Whether to use self-certainty for the rewards. If `True`, the self-certainty is computed for "
            "each token. TODO: This feature is not yet implemented."
        },
    )
    loss_type: str = field(
        default="bnpo",
