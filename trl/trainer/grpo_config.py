...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        vllm_device (`str`, *optional*, defaults to `"auto"`):
            Device where vLLM generation will run. If set to `"auto"` (default), the system will automatically select
            the next available GPU after the last one used for training. This assumes that training has not already
            occupied all available GPUs.
    ...
    vllm_device: Optional[str] = field(
        default="auto",
        metadata={
            "help": "Device where vLLM generation will run. If set to `auto` (default), the system will automatically "
            "select the next available GPU after the last one used for training. This assumes that training has not "
            "already occupied all available GPUs."
        },
    )
