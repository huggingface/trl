...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        delta: (`float`, *optional*, defaults to `None`):
            Delta value for the upper clipping bound in two-sided GRPO. Recommended to be > 1 + epsilon. This method
            was introduced in the [INTELLECT-2 tech report](https://huggingface.co/papers/2505.07291).
