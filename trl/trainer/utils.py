...
@dataclass
class DataCollatorForChatMLTestingCGPO:
    """
    Data collator for ChatML format datasets.
    """
    ...
    def __call__(self, examples: List[Dict[str, Any]]) -> Dict[str, torch.Tensor]:
        ...
        return {
            "prompt_baseline_ids": input_ids,
            "prompt_baseline_mask": attention_mask,
            "prompt_baseline_labels": labels,
            "prompt_ids": prompts_input_ids,
