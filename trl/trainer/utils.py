...
def create_model_from_path(
    ...
    # On MPS, device_map="auto" can also segfault while loading non-float32 checkpoints
    # (see https://github.com/huggingface/transformers/issues/48029), so we avoid it there too.
